...
BEGIN(Client)
class CPoster2 final : public CGameObject
{
...
public:
	CPoster2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPoster2(const CPoster2& CRing_Top);
	virtual ~CPoster2() = default;
...
private:
	OBJINFODESC m_Info;
public:
	static CPoster2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
