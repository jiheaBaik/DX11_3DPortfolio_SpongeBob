...
BEGIN(Client)
class CMan final : public CGameObject
{
...
public:
	CMan(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMan(const CMan& Prototype);
...
private:
	OBJINFODESC m_Info;
public:
	static CMan* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
