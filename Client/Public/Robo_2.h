...
END
BEGIN(Client)
class CRobo_2 final : public CGameObject
{
public:
...
public:
	CRobo_2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRobo_2(const CRobo_2& Prototype);
	virtual ~CRobo_2() = default;
public:
...
private:
	OBJINFODESC m_Info;
public:
	static CRobo_2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
