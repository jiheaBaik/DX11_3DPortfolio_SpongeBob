...
END
BEGIN(Client)
class CBoss_Sandy_Head_Glass : public CGameObject
{
public:
...
public:
	CBoss_Sandy_Head_Glass(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBoss_Sandy_Head_Glass(const CBoss_Sandy_Head_Glass& Prototype);
	virtual ~CBoss_Sandy_Head_Glass() = default;
public:
...
public:
	static CBoss_Sandy_Head_Glass* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
