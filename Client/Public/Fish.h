...
BEGIN(Client)
class CFish final : public CGameObject
{
...
private:
	CFish(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
	...
	void Set_FishRender(_bool _iSandyHit) { m_IsSandyHit = _iSandyHit; }
...
public:
	static CFish* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
