...
public:
	CFlame(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CFlame(const CFlame& Prototype);
...
public:
	static CFlame* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
