...
class CRing_Pillar final : public CGameObject
{
...
public:
	CRing_Pillar(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRing_Pillar(const CRing_Pillar& CRing_Top);
	virtual ~CRing_Pillar() = default;
...
private:
	OBJINFODESC m_Info;
public:
	static CRing_Pillar* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
