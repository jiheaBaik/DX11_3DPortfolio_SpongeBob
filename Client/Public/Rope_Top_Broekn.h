...
BEGIN(Client)
class CRope_Top_Broekn final : public CGameObject
{
public:
...
public:
	CRope_Top_Broekn(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRope_Top_Broekn(const CRope_Top_Broekn& CRing_Top);
	virtual ~CRope_Top_Broekn() = default;
...
public:
	static CRope_Top_Broekn* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
