...
BEGIN(Client)
class CBubbleUI final : public CGameObject
{
...
private:
	CBubbleUI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBubbleUI(const CBubbleUI& Prototype);
	virtual ~CBubbleUI() = default;
...
public:
	static CBubbleUI* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
