#include "stdafx.h"
#include "..\Public\Scoreboard_Ropes.h"



#include "GameInstance.h"

CScoreboard_Ropes::CScoreboard_Ropes(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CScoreboard_Ropes::CScoreboard_Ropes(const CScoreboard_Ropes & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CScoreboard_Ropes::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CScoreboard_Ropes::NativeConstruct(void * pArg)
{
...
void CScoreboard_Ropes::Tick(_double TimeDelta)
{
}

void CScoreboard_Ropes::LateTick(_double TimeDelta)
{
...
HRESULT CScoreboard_Ropes::Render()
{
...
HRESULT CScoreboard_Ropes::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Scoreboard_Ropes"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CScoreboard_Ropes::SetUp_ConstantTable()
{
...
CScoreboard_Ropes * CScoreboard_Ropes::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CScoreboard_Ropes*		pInstance = new CScoreboard_Ropes(pDevice, pContext);
...
CGameObject * CScoreboard_Ropes::Clone(void * pArg)
{
	CScoreboard_Ropes*		pInstance = new CScoreboard_Ropes(*this);
