#include "stdafx.h"
#include "..\Public\BubblePangEffect.h"
#include "GameInstance.h"
#include<iostream>

CBubblePangEffect::CBubblePangEffect(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CBubblePangEffect::CBubblePangEffect(const CBubblePangEffect & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CBubblePangEffect::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CBubblePangEffect::NativeConstruct(void * pArg)
{	
...
void CBubblePangEffect::Tick(_double TimeDelta)
{
...
void CBubblePangEffect::LateTick(_double TimeDelta)
{
...
HRESULT CBubblePangEffect::Render()
{
...
HRESULT CBubblePangEffect::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(TEXT("Com_Texture"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_BubblePang"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CBubblePangEffect::SetUp_SRV()
{
...
CBubblePangEffect * CBubblePangEffect::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CBubblePangEffect*		pInstance = new CBubblePangEffect(pDevice, pContext);
...
CGameObject * CBubblePangEffect::Clone(void * pArg)
{
	CBubblePangEffect*		pInstance = new CBubblePangEffect(*this);
