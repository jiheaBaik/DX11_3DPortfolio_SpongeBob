#include "stdafx.h"
#include "..\Public\Fish_A.h"


#include "GameInstance.h"

CFish_A::CFish_A(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_A::CFish_A(const CFish_A & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_A::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_A::NativeConstruct(void * pArg)
{
...
void CFish_A::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_A::LateTick(_double TimeDelta)
{
...
HRESULT CFish_A::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_A"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_A::SetUp_ConstantTable()
{
...
CFish_A * CFish_A::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_A*		pInstance = new CFish_A(pDevice, pContext);
...
CGameObject * CFish_A::Clone(void * pArg)
{
	CFish_A*		pInstance = new CFish_A(*this);
