#include "stdafx.h"
#include "..\Public\Fish_C.h"

#include "GameInstance.h"

CFish_C::CFish_C(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_C::CFish_C(const CFish_C & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_C::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_C::NativeConstruct(void * pArg)
{
...
void CFish_C::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_C::LateTick(_double TimeDelta)
{
...
HRESULT CFish_C::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_C"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_C::SetUp_ConstantTable()
{
...
CFish_C * CFish_C::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_C*		pInstance = new CFish_C(pDevice, pContext);
...
CGameObject * CFish_C::Clone(void * pArg)
{
	CFish_C*		pInstance = new CFish_C(*this);
