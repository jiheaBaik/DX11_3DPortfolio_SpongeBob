#include "stdafx.h"
#include "..\Public\Pos_Light.h"

#include "GameInstance.h"

CPos_Light::CPos_Light(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CPos_Light::CPos_Light(const CPos_Light & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CPos_Light::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CPos_Light::NativeConstruct(void * pArg)
{
...
void CPos_Light::Tick(_double TimeDelta)
{
}

void CPos_Light::LateTick(_double TimeDelta)
{
...
HRESULT CPos_Light::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Pos_Light"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CPos_Light::SetUp_ConstantTable()
{
...
CPos_Light * CPos_Light::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPos_Light*		pInstance = new CPos_Light(pDevice, pContext);
...
CGameObject * CPos_Light::Clone(void * pArg)
{
	CPos_Light*		pInstance = new CPos_Light(*this);
