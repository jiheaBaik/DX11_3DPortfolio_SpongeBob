#include "stdafx.h"
#include "..\Public\Fish_B2.h"


#include "GameInstance.h"

CFish_B2::CFish_B2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_B2::CFish_B2(const CFish_B2 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_B2::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_B2::NativeConstruct(void * pArg)
{
...
void CFish_B2::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_B2::LateTick(_double TimeDelta)
{
...
HRESULT CFish_B2::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_B2"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_B2::SetUp_ConstantTable()
{
...
CFish_B2 * CFish_B2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_B2*		pInstance = new CFish_B2(pDevice, pContext);
...
CGameObject * CFish_B2::Clone(void * pArg)
{
	CFish_B2*		pInstance = new CFish_B2(*this);
