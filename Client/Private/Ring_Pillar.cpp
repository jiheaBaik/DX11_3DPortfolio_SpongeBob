#include "stdafx.h"
#include "..\Public\Ring_Pillar.h"
#include "GameInstance.h"

CRing_Pillar::CRing_Pillar(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRing_Pillar::CRing_Pillar(const CRing_Pillar & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CRing_Pillar::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CRing_Pillar::NativeConstruct(void * pArg)
{
...
void CRing_Pillar::Tick(_double TimeDelta)
{
}

void CRing_Pillar::LateTick(_double TimeDelta)
{
...
HRESULT CRing_Pillar::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Ring_Pillar"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CRing_Pillar::SetUp_ConstantTable()
{
...
CRing_Pillar * CRing_Pillar::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRing_Pillar*		pInstance = new CRing_Pillar(pDevice, pContext);
...
CGameObject * CRing_Pillar::Clone(void * pArg)
{
	CRing_Pillar*		pInstance = new CRing_Pillar(*this);
