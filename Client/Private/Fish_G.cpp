#include "stdafx.h"
#include "..\Public\Fish_G.h"


#include "GameInstance.h"

CFish_G::CFish_G(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_G::CFish_G(const CFish_G & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_G::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_G::NativeConstruct(void * pArg)
{
...
void CFish_G::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_G::LateTick(_double TimeDelta)
{
...
HRESULT CFish_G::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_G"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_G::SetUp_ConstantTable()
{
...
CFish_G * CFish_G::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_G*		pInstance = new CFish_G(pDevice, pContext);
...
CGameObject * CFish_G::Clone(void * pArg)
{
	CFish_G*		pInstance = new CFish_G(*this);
