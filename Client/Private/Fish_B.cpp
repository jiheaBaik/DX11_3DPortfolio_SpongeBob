#include "stdafx.h"
#include "..\Public\Fish_B.h"


#include "GameInstance.h"

CFish_B::CFish_B(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_B::CFish_B(const CFish_B & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_B::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_B::NativeConstruct(void * pArg)
{
...
void CFish_B::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_B::LateTick(_double TimeDelta)
{
...
HRESULT CFish_B::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_B"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_B::SetUp_ConstantTable()
{
...
CFish_B * CFish_B::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_B*		pInstance = new CFish_B(pDevice, pContext);
...
CGameObject * CFish_B::Clone(void * pArg)
{
	CFish_B*		pInstance = new CFish_B(*this);
