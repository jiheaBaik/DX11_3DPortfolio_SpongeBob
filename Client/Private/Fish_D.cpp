#include "stdafx.h"
#include "..\Public\Fish_D.h"


#include "GameInstance.h"

CFish_D::CFish_D(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_D::CFish_D(const CFish_D & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_D::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_D::NativeConstruct(void * pArg)
{
...
void CFish_D::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_D::LateTick(_double TimeDelta)
{
...
HRESULT CFish_D::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_D"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_D::SetUp_ConstantTable()
{
...
CFish_D * CFish_D::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_D*		pInstance = new CFish_D(pDevice, pContext);
...
CGameObject * CFish_D::Clone(void * pArg)
{
	CFish_D*		pInstance = new CFish_D(*this);
