...
void CTree::LateTick(_double TimeDelta)
{
...
HRESULT CTree::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_FIELD, TEXT("Prototype_Component_Model_Tree"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(m_Info.fPos.x, m_Info.fPos.y -3, m_Info.fPos.z, 1));
