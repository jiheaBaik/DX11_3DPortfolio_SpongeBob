#include "stdafx.h"
#include "..\Public\Poster.h"

#include "GameInstance.h"

CPoster::CPoster(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CPoster::CPoster(const CPoster & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CPoster::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CPoster::NativeConstruct(void * pArg)
{
...
void CPoster::Tick(_double TimeDelta)
{
}

void CPoster::LateTick(_double TimeDelta)
{
...
HRESULT CPoster::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Poster"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CPoster::SetUp_ConstantTable()
{
...
CPoster * CPoster::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPoster*		pInstance = new CPoster(pDevice, pContext);
...
CGameObject * CPoster::Clone(void * pArg)
{
	CPoster*		pInstance = new CPoster(*this);
