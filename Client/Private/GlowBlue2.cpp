#include "stdafx.h"
#include "..\Public\GlowBlue2.h"
#include "GameInstance.h"
#include<iostream>

CGlowBlue2::CGlowBlue2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CGlowBlue2::CGlowBlue2(const CGlowBlue2 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CGlowBlue2::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CGlowBlue2::NativeConstruct(void * pArg)
{	
...
void CGlowBlue2::Tick(_double TimeDelta)
{
	...
	if (fPos.y <= 0.5)//1,0,1
	{
		...
		m_pTransformCom->Set_State(CTransform::STATE_POSITION, vsandyBoadyPos + XMVectorSet(0, 4, 0, 1));
	}
...
//	RELEASE_INSTANCE(CGameInstance);
	...
	{
		m_pTransformCom->Set_Scaled(_float3(10, 10, 10));
	}
...
void CGlowBlue2::LateTick(_double TimeDelta)
{
...
HRESULT CGlowBlue2::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(TEXT("Com_Texture"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_GrowBlue2"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CGlowBlue2 * CGlowBlue2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CGlowBlue2*		pInstance = new CGlowBlue2(pDevice, pContext);
...
CGameObject * CGlowBlue2::Clone(void * pArg)
{
	CGlowBlue2*		pInstance = new CGlowBlue2(*this);
