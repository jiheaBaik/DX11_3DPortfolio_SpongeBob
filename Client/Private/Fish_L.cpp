#include "stdafx.h"
#include "..\Public\Fish_L.h"


#include "GameInstance.h"

CFish_L::CFish_L(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_L::CFish_L(const CFish_L & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_L::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_L::NativeConstruct(void * pArg)
{
...
void CFish_L::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_L::LateTick(_double TimeDelta)
{
...
HRESULT CFish_L::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_L"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_L::SetUp_ConstantTable()
{
...
CFish_L * CFish_L::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_L*		pInstance = new CFish_L(pDevice, pContext);
...
CGameObject * CFish_L::Clone(void * pArg)
{
	CFish_L*		pInstance = new CFish_L(*this);
