#include "stdafx.h"
#include "..\Public\SmokeEffect.h"
#include "GameInstance.h"
#include<iostream>

CSmokeEffect::CSmokeEffect(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CSmokeEffect::CSmokeEffect(const CSmokeEffect & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CSmokeEffect::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CSmokeEffect::NativeConstruct(void * pArg)
{	
...
void CSmokeEffect::Tick(_double TimeDelta)
{
...
void CSmokeEffect::LateTick(_double TimeDelta)
{
...
HRESULT CSmokeEffect::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(TEXT("Com_Texture"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_SmokeEffect"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CSmokeEffect::SetUp_SRV()
{
...
CSmokeEffect * CSmokeEffect::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CSmokeEffect*		pInstance = new CSmokeEffect(pDevice, pContext);
...
CGameObject * CSmokeEffect::Clone(void * pArg)
{
