#include "stdafx.h"
#include "..\Public\Poster2.h"

#include "GameInstance.h"

CPoster2::CPoster2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CPoster2::CPoster2(const CPoster2 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CPoster2::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CPoster2::NativeConstruct(void * pArg)
{
...
void CPoster2::Tick(_double TimeDelta)
{
}

void CPoster2::LateTick(_double TimeDelta)
{
...
HRESULT CPoster2::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Poster2"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CPoster2::SetUp_ConstantTable()
{
...
CPoster2 * CPoster2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPoster2*		pInstance = new CPoster2(pDevice, pContext);
...
CGameObject * CPoster2::Clone(void * pArg)
{
	CPoster2*		pInstance = new CPoster2(*this);
