...
CRobo_3::CRobo_3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CGameObject(pDevice, pContext)
{
}

CRobo_3::CRobo_3(const CRobo_3 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CRobo_3::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CRobo_3::NativeConstruct(void * pArg)
{
...
void CRobo_3::Tick(_double TimeDelta)
{
	...
	if (pCCamera->Get_m_bIsDirector_End())
	{
		...
		{
			CGameInstance::Get_Instance()->PlayMySound(L"SFX_Tubelet_Pop_001.ogg", CSoundMgr::MONSTER, 0.3f);
...
void CRobo_3::LateTick(_double TimeDelta)
{
...
HRESULT CRobo_3::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_FIELD, TEXT("Prototype_Component_Model_Robo3"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
void CRobo_3::SettingMotion(_double TimeDelt)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CRobo_3 * CRobo_3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRobo_3*		pInstance = new CRobo_3(pDevice, pContext);
...
CGameObject * CRobo_3::Clone(void * pArg)
{
	CRobo_3*		pInstance = new CRobo_3(*this);
