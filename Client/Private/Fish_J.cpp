...
HRESULT CFish_J::NativeConstruct_Prototype()
{
	return S_OK;
}
...
void CFish_J::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_J::LateTick(_double TimeDelta)
{
...
HRESULT CFish_J::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_J"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_J::SetUp_ConstantTable()
{
