...
CJelly_Pink::CJelly_Pink(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CGameObject(pDevice, pContext)
{
}

CJelly_Pink::CJelly_Pink(const CJelly_Pink & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CJelly_Pink::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CJelly_Pink::NativeConstruct(void * pArg)
{
...
void CJelly_Pink::Tick(_double TimeDelta)
{
...
void CJelly_Pink::LateTick(_double TimeDelta)
{
...
void CJelly_Pink::SettingMotion(_double TimeDelt)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	CPlayer* pPlayer = nullptr;
		...
		case ATTACK:
			m_pVIBufferCom->Set_CurrentAnimIndex(2);
			m_pVIBufferCom->Update_Boss_Sandy_Animation(TimeDelt , 2, false, 2);
			break;
		default:
...
HRESULT CJelly_Pink::IsDie(_double TimeDelta)
{
...
HRESULT CJelly_Pink::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_FIELD, TEXT("Prototype_Component_Model_Jelly_Pink"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
CJelly_Pink * CJelly_Pink::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CJelly_Pink*		pInstance = new CJelly_Pink(pDevice, pContext);
...
CGameObject * CJelly_Pink::Clone(void * pArg)
{
	CJelly_Pink*		pInstance = new CJelly_Pink(*this);
