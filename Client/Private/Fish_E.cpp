#include "stdafx.h"
#include "..\Public\Fish_E.h"


#include "GameInstance.h"

CFish_E::CFish_E(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CFish_E::CFish_E(const CFish_E & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CFish_E::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CFish_E::NativeConstruct(void * pArg)
{
...
void CFish_E::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CFish_E::LateTick(_double TimeDelta)
{
...
HRESULT CFish_E::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fish_E"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CFish_E::SetUp_ConstantTable()
{
...
CFish_E * CFish_E::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFish_E*		pInstance = new CFish_E(pDevice, pContext);
...
CGameObject * CFish_E::Clone(void * pArg)
{
	CFish_E*		pInstance = new CFish_E(*this);
