...
BEGIN(Tool)
class CRing_Top final : public CGameObject
{
...
public:
	CRing_Top(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRing_Top(const CRing_Top& CRing_Top);
	virtual ~CRing_Top() = default;
...
private:
	OBJINFODESC m_Info;
public:
	static CRing_Top* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
