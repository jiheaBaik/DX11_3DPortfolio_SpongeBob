...
BEGIN(Tool)
class CSpongeBob final : public CGameObject
{
...
public:
	CSpongeBob(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CSpongeBob(const CSpongeBob& Prototype);
	virtual ~CSpongeBob() = default;
...
public:
	static CSpongeBob* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
