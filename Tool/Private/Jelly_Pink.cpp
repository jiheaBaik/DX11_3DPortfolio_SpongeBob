...
HRESULT CJelly_Pink::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Jelly_Pink"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CJelly_Pink::SetUp_ConstantTable()
{
