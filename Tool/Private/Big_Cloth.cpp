#include "..\Public\Big_Cloth.h"



#include "GameInstance.h"

CBig_Cloth::CBig_Cloth(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CBig_Cloth::CBig_Cloth(const CBig_Cloth & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CBig_Cloth::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CBig_Cloth::NativeConstruct(void * pArg)
{
...
void CBig_Cloth::Tick(_double TimeDelta)
{
}

void CBig_Cloth::LateTick(_double TimeDelta)
{
...
HRESULT CBig_Cloth::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Big_Cloth"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CBig_Cloth::SetUp_ConstantTable()
{
...
CBig_Cloth * CBig_Cloth::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CBig_Cloth*		pInstance = new CBig_Cloth(pDevice, pContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX("Failed to Created : CBig_Cloth");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CBig_Cloth::Clone(void * pArg)
{
	CBig_Cloth*		pInstance = new CBig_Cloth(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Cloned : CBig_Cloth");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CBig_Cloth::Free()
{
	__super::Free();
