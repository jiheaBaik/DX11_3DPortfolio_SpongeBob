#include "..\Public\Patrick.h"
#include "GameInstance.h"

CPatrick::CPatrick(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CPatrick::CPatrick(const CPatrick & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CPatrick::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CPatrick::NativeConstruct(void * pArg)
{
...
HRESULT CPatrick::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Patrick"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CPatrick::SetUp_ConstantTable()
{
...
CPatrick * CPatrick::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPatrick*		pInstance = new CPatrick(pDevice, pContext);
...
CGameObject * CPatrick::Clone(void * pArg)
{
	CPatrick*		pInstance = new CPatrick(*this);
