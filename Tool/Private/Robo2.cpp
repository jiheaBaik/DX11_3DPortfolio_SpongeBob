#include "..\Public\Robo2.h"


#include "GameInstance.h"

CRobo2::CRobo2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRobo2::CRobo2(const CRobo2 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CRobo2::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CRobo2::NativeConstruct(void * pArg)
{
...
void CRobo2::Tick(_double TimeDelta)
{
	m_pVIBufferCom->Update_Animation(TimeDelta);

}

void CRobo2::LateTick(_double TimeDelta)
{
...
HRESULT CRobo2::SetUp_Components()
{
	...
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Robo2"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CRobo2::SetUp_ConstantTable()
{
...
CRobo2 * CRobo2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRobo2*		pInstance = new CRobo2(pDevice, pContext);
...
CGameObject * CRobo2::Clone(void * pArg)
{
	CRobo2*		pInstance = new CRobo2(*this);
