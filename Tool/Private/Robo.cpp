...
HRESULT CRobo::SetUp_Components()
{
	...
	if (FAILED(__super::Add_Component(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Robo"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
...
HRESULT CRobo::SetUp_ConstantTable()
{
