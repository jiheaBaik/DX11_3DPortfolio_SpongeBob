#include "..\Public\SpongeBob_NonAnim.h"


#include "GameInstance.h"

CSpongeBob_NonAnim::CSpongeBob_NonAnim(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CSpongeBob_NonAnim::CSpongeBob_NonAnim(const CSpongeBob_NonAnim & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CSpongeBob_NonAnim::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CSpongeBob_NonAnim::NativeConstruct(void * pArg)
{
...
void CSpongeBob_NonAnim::Tick(_double TimeDelta)
{
	
}

void CSpongeBob_NonAnim::LateTick(_double TimeDelta)
{
...
HRESULT CSpongeBob_NonAnim::Render()
{
...
HRESULT CSpongeBob_NonAnim::SetUp_ConstantTable()
{
...
CSpongeBob_NonAnim * CSpongeBob_NonAnim::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CSpongeBob_NonAnim*		pInstance = new CSpongeBob_NonAnim(pDevice, pContext);
...
CGameObject * CSpongeBob_NonAnim::Clone(void * pArg)
{
	CSpongeBob_NonAnim*		pInstance = new CSpongeBob_NonAnim(*this);
