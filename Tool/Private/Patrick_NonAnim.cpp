#include "..\Public\Patrick_NonAnim.h"
...
HRESULT CPatrick_NonAnim::NativeConstruct_Prototype()
{
	return S_OK;
}
...
void CPatrick_NonAnim::Tick(_double TimeDelta)
{
}

void CPatrick_NonAnim::LateTick(_double TimeDelta)
{
...
HRESULT CPatrick_NonAnim::Render()
{
...
HRESULT CPatrick_NonAnim::SetUp_ConstantTable()
{
