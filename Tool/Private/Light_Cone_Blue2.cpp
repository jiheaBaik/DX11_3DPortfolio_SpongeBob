#include "..\Public\Light_Cone_Blue2.h"

#include "GameInstance.h"



CLight_Cone_Blue2::CLight_Cone_Blue2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CLight_Cone_Blue2::CLight_Cone_Blue2(const CLight_Cone_Blue2 & Prototype)
	: CGameObject(Prototype)
{
}

HRESULT CLight_Cone_Blue2::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CLight_Cone_Blue2::NativeConstruct(void * pArg)
{
...
HRESULT CLight_Cone_Blue2::Render()
{
...
HRESULT CLight_Cone_Blue2::SetUp_ConstantTable()
{
...
CLight_Cone_Blue2 * CLight_Cone_Blue2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CLight_Cone_Blue2*		pInstance = new CLight_Cone_Blue2(pDevice, pContext);
...
CGameObject * CLight_Cone_Blue2::Clone(void * pArg)
{
	CLight_Cone_Blue2*		pInstance = new CLight_Cone_Blue2(*this);
